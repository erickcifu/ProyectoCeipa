...
class TutorForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {'nombres_tutor':'Nombres', 'apellidos_tutor':'Apellidos', 'DPI':"DPI", 'fecha_nacimiento':'Fecha de nacimiento', 'direccion_tutor':'Direccion', 'telefono':"Telefono", 'correo':"Correo", 'fotografia':"Fotografia", 'muni':"Municipalidad", 'genero':"Genero", 'parentesco':'Parentesco', 'estado_tutor':'Estado'}
