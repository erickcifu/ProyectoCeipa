...
class ReportesAlumnos(IsDirectorGeneralMixin, generic.ListView):
    model = Alumno
...
class CantidadAlumnosPorGenero(IsDirectorGeneralMixin, generic.ListView):
    model = Alumno
...
class AlumnosPorEdad(IsDirectorGeneralMixin, generic.ListView):
    model = Alumno
    template_name = 'educacion/reportes/canditadAlumnosPorGenero.html'
    context_object_name = 'obj'
...
class AlumnosPorOcupacion(IsDirectorGeneralMixin, generic.ListView):
    model = ocupacion
    template_name = 'educacion/reportes/canditadAlumnosPorGenero.html'
    context_object_name = 'obj'
    def get_context_data(self, **kwargs):
...
class CantidadAlumnosPorCentro(IsDirectorGeneralMixin, generic.ListView):
