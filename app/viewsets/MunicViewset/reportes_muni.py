...
class total_corporaciones(LoginRequiredMixin, generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['total_vacunados_corp'] = CorporacionMunicipal.objects.filter(estado_corporacion=True, vacuna=True).count()
...
class Total_lideres(LoginRequiredMixin, generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['total_lideres_vacunados'] = LiderComunitario.objects.filter(estado=True, vacuna_covid=True).count()
