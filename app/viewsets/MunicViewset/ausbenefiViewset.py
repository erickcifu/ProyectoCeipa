...
class AusenBeneficiadoView(LoginRequiredMixin, generic.ListView):
    ...
    template_name = 'municipalizacion/ausbenefi_list.html'
    context_object_name = 'obj'
    login_url = 'app:login'

class AusenBeneficiadoNew(LoginRequiredMixin, generic.CreateView):
    model = AusenBeneficiado
    template_name = "municipalizacion/ausbenefi_form.html"
    context_object_name = "obj"
    form_class = AusenBeneficiadoForm
    success_url = reverse_lazy("municipalizacion:ausbenefi_list")
    login_url = 'app:login'
