...
from .educacion_serializer.ocuapacionSerializer import ocupacionRegistroSerializer, OcupacionSerializer
...
from .educacion_serializer.psicologicoSerializer import psicologicoRegistroSerializer, psicologicoSerializer
from .educacion_serializer.tipopisoSerialiazer import tipopisoRegistroSerializer, tipopisoSerializer
from .educacion_serializer.seccionSerialiazer import seccionRegistroSerializer, seccionSerializer
from .educacion_serializer.categoriaSerializers import categoriaRegistroSerializer, categoriaSerializer
from .educacion_serializer.centropersonaSerializer import centropersonaRegistroSerializer,centropersonaSerializer
from .educacion_serializer.estudiosantSerialiazer import estudiosantRegistroSerializer, estudiosantSerializer
from .educacion_serializer.municipioSerializer import municipioRegistroSerializer, MuniSerializer
...
from .educacion_serializer.alpadecimientoSerializer import AlpadecimientoRegistroSerializer, AlpadecimientoSerializer
