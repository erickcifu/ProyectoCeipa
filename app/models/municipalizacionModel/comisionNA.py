...
class ComisionNA(models.Model):
    ...
    gorg_comision = models.ForeignKey(GOrganizado, on_delete=models.CASCADE, related_name="gorga_comina", null=True, blank=True)
    cg_comision = models.ForeignKey(CargoGrupo, on_delete=models.CASCADE, related_name="carg_comina", null=True, blank=True)
