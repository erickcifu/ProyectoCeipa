...
class Inscripcion_etapa(models.Model):
    ...
    ciclo_etapa = models.ForeignKey(Ciclo, on_delete=models.CASCADE, related_name="ce_insc")
    etapa_insc = models.ForeignKey(Etapa, on_delete=models.CASCADE, related_name="ins_e")
